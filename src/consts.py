...
class Coords(Enum):
    ...
    ANDROID_AMOUNT_SECTION = (1350, 495)
    ANDROID_CLOSE_CASHIER_BUTTON = (1439, 220)
    ANDROID_CLOSE_EMULATOR_BUTTON = (1446, 175)
    ANDROID_CLOSE_EMULATOR_BUTTON_BIG = (1880, 175)
    ANDROID_OPEN_EMULATOR_BUTTON = (115, 50)
    ANDROID_DONT_SHOW_TODAY = (1110, 870)
...
class Colors:
    ...
    ANDROID_CLOSE_BUTTON_COLOR = 235, 85, 62
